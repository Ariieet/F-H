...
_____________________________________________________________________________
"""
path = "C:/Users/Ariette/Documents/5e session physique/PhysEx/F&H/Données/Acquisition 5 (multi-pic).csv"
...
liste_des_indexes_des_pics = determiner_indexes_maximums_scipy(valeurs_avec_bonnes_unites_determination_des_pics, 1,
                                                               hauteur_minimum=None, distance_minumum=55)
...
plt.figure()
plt.title("Figure 7: Pics d'ionisations du mercure, pics multiples.")
